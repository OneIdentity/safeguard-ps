...
FunctionsToExport = @(
    ...
    'Connect-SafeguardSps','Disconnect-SafeguardSps','Get-SafeguardSpsLoginMethod','Invoke-SafeguardSpsMethod',
    ...
    'Enable-SafeguardAssetAccount','Disable-SafeguardAssetAccount',
